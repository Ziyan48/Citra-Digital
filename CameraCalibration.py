...
print ("RMS: ", rms)
print ("matrik",camera_matrix)
print ("koefesien",distortion_coeff)

image_to_undistort = cv2.imread("chessboard05.jpg", 0)
...
# undistorted_image = cv2.undistort(image_to_undistort, camera_matrix, distortion_coeff)
